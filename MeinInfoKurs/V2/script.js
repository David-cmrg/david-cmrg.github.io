      ...
      const feedbacks = [...document.querySelectorAll('.feedback')];
        let posClasses = ['pos-0','pos-1','pos-2','pos-3','pos-4'];

        function rotatePositions() {
          // Jede 3 Sekunden eine Position nach links verschieben
          // z.B. pos-0 wird pos-4, pos-1 wird pos-0 usw.
          posClasses.unshift(posClasses.pop());
          feedbacks.forEach((el, i) => {
            el.classList.remove(...posClasses);
            el.classList.add(posClasses[i]);

            // Accessibility: Nur mittlere Karte ist sichtbar und focusable
            if (posClasses[i] === 'pos-2') {
        ...
        setInterval(rotatePositions, 4500);
      ...
      // Custom Personal ADs
        ...
        window.addEventListener("load", () => {
          setTimeout(() => {
            showAdModal();
            // Nach dem ersten Anzeigen das Intervall starten
            setInterval(showAdModal, 120000);
          }, 25000);
        });
        ...
        function showAdModal() {
          ...
          // Pick random ad
          const ad = myAds[Math.floor(Math.random() * myAds.length)];
...
document.addEventListener("DOMContentLoaded", () => {
  const tabs = document.querySelectorAll('.item-selector h4');
  const contents = document.querySelectorAll('.content-container-selector .content');

  tabs.forEach(tab => {
    tab.addEventListener('click', () => {
      
      tabs.forEach(t => t.classList.remove('selector-active'));
      contents.forEach(c => c.classList.remove('selector-active'));

      tab.classList.add('selector-active');

      const target = document.getElementById(tab.dataset.target);
      if (target) {
        target.classList.add('selector-active');
      }
    });
  });
});
...
let showingPreview = false;
        ...
        function runHtmlCode() {
            ...
            if (showingPreview) {
                ...
                button.textContent = "Webseite Anzeigen";
            } else {
                // Vorschau anzeigen
                iframe.srcdoc = code;
                iframe.style.display = "block";
                codeContainer.style.display = "none";
                button.textContent = "Code zeigen";
            }
  ...
  */
  ...
  window.__h82AlnkH6D91__("");
