public class MarklerFirma3 {
  
  public static void main(String[] args) {
    double  GrundstuecksPreis, Marklergebuehr, GesamtKosten, Breite, Laenge, QuadratMeterPreis, Gebuehr, Mehrwertsteuer, Gewinnkalkulation, Jahressteigerung, Gewinn, Gewinn2;
     Jahressteigerung = 1.99 ;
...
for (int Jahre = 0; GrundstuecksPreis=Gewinn; Jahre++) {
       Gewinn2 = GrundstuecksPreis*Jahressteigerung*Jahre;
}
       System.out.println("");
