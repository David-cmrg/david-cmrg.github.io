public class Handykosten {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("");
    if (Jugendlicher = true) {
      System.out.println("Gesamtkosten mit Rabatt als Jugendlicher: " + GesamtMitRabatt + " Euro");
      System.out.println("Gesamtkosten mit Flat als Jugendlicher: " + GesamtMitFlat + " Euro" );
    } else {
      System.out.println("Gesamtkosten mit Flat: " + Flatrate + " Euro" );
    }
    System.out.println("");
